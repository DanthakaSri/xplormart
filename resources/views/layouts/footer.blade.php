<!-- FOOTER -->
<footer style="background-image: url(img/banner/banner1.png);">
    <!-- FOOTER INFO -->
                ...
                <div class="col-sm-7 col-xs-12">
                    <div class="footerText">
                        <a href="index.html" class="footerLogo">
                            ...
                            <img src="{{asset('img/logo_footer.png')}}" alt="footer_log" width="160" height="98" >
                        </a>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec eleifend justo vel elit placerat pulvinar.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec eleifend justo vel elit placerat pulvinar.</p>
                        <ul class="list-styled list-contact">
                            <li><i class="fa fa-phone" aria-hidden="true"></i>[+61] 455 503 013 </li>
                            <li><i class="fa fa-envelope" aria-hidden="true"></i><a href="#">info@exploremart.com</a></li>
                        </ul>
                    </div>
                </div>
