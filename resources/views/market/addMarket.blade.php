                            ...
                            <div class="profileIntro paraMargin">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-xs-12">
                                        <div class="form-group col-sm-6 col-xs-12">
                                            <label for="listingCountry"><span
                                                    class="mandatory_field">*</span>Country</label>
                                            <div class="contactSelect">
                                                <select name="country" id="listingCountry"
                                        ...
                                        <div class="form-group col-sm-6 col-xs-12">
                                            <label for="listingAddress"><span class="mandatory_field">*</span>Street
                                                Address</label>
                                    ...
                                    <div class="col-sm-12 col-xs-12">
                                        <div class="form-group col-sm-6 col-xs-12">
                                            ...
                                            <input type="text" name="postcode" value="{{old('postcode')}}"
                                                   class="form-control" id="listingPostcode"
                                        ...
                                        <div class="form-group col-sm-6 col-xs-12">
                                            <label for="listingSuburb"><span
                                                    class="mandatory_field">*</span>Suburb</label>
                                            <input type="text" name="suburb" value="{{old('suburb')}}"
                                                   class="form-control" id="listingSuburb"
                                                   placeholder="Suburb">
                                    ...
                                    <div class="col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group col-sm-6 col-xs-12">
                                            <label for="listingPhone"><span
                                                    class="mandatory_field">*</span>Phone</label>
                                    ...
                                    <div class="col-sm-12 col-xs-12">
                                        <div class="form-group col-sm-6 col-xs-12">
                                            <label for="listingEmail"><span
                                                    class="mandatory_field">*</span>Email</label>
                                        ...
                                        <div class="form-group col-sm-6 col-xs-12">
                                            ...
                                            <input type="text" name="website" value="{{old('website')}}"
                                                   class="form-control" id="listingWebsite"
                                                   placeholder="http://">
                            ...
                            <div class="profileIntro paraMargin">
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-6 col-xs-12">
                                        ...
                                        <input type="text" name="fb_url" value="{{old('fb_url')}}" class="form-control"
                                               id="facebookUrl"
                                    ...
                                    <div class="form-group col-sm-6 col-xs-12">
                                        ...
                                        <input type="text" name="twitter_url" value="{{old('twitter_url')}}"
                                               class="form-control" id="twitterUrl"
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12">
                                        <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                            ...
                                            <input type="text" name="mondayFrom" class="form-control timePick"
                                                   id="mondayTime"
                                                   placeholder="From">
                                            <input type="text" name="mondayTo" class="form-control hours timePick"
                                                   id="mondayTime"
                                                   placeholder="To">
                                        ...
                                        <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                            ...
                                            <input type="text" name="tuesdayFrom" class="form-control timePick"
                                                   id="tuesdayTime"
                                                   placeholder="From">
                                            <input type="text" name="tuesdayTo" class="form-control timePick hours"
                                                   id="tuesdayTime"
                                                   placeholder="To">
                                        ...
                                        <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                            ...
                                            <input type="text" name="wednesdayFrom" class="form-control timePick"
                                                   id="wednesdayTime"
                                                   placeholder="From">
                                            <input type="text" name="wednesdayTo" class="form-control timePick hours"
                                                   id="wednesdayTime"
                                                   placeholder="To">
                                    ...
                                    <div class="col-xs-12 col-sm-12">
                                        ...
                                        <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                            ...
                                            <input type="text" name="thursdayFrom" class="form-control timePick"
                                                   id="thrusdayTime"
                                                   placeholder="From">
                                            <input type="text" name="thursdayTo" class="form-control timePick hours"
                                                   id="thrusdayTime"
                                                   placeholder="To">
                                        ...
                                        <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                            ...
                                            <input type="text" name="fridayFrom" class="form-control timePick"
                                                   id="fridayTime"
                                                   placeholder="From">
                                            <input type="text" name="fridayTo" class="form-control timePick hours"
                                                   id="fridayTime"
                                                   placeholder="To">
                                        ...
                                        <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                            ...
                                            <input type="text" name="saturdayFrom" class="form-control timePick"
                                                   id="saturdayTime"
                                                   placeholder="From">
                                            <input type="text" name="saturdayTo" class="form-control timePick hours"
                                                   id="saturdayTime"
                                                   placeholder="To">
                                    ...
                                    <div class="col-xs-12 col-sm-12">
                                        ...
                                        <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                            ...
                                            <input type="text" name="sundayFrom" class="form-control timePick"
                                                   id="sundayTime"
                                                   placeholder="From">
                                            <input type="text" name="sundayTo" class="form-control timePick hours"
                                                   id="sundayTime"
                                                   placeholder="To">
